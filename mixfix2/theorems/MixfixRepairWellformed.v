...
Proof.
  ...
  - destruct (decide (rncf Q (large_production X1 σ (terminal a)) t1 τ (leaf a))).
    + constructor; auto. constructor.
    + destruct n. intros ???. inv H0. inv H2.
  - destruct (decide (rncf Q (large_production X1 σ E) t1 τ (small_node (small_production opt_a) opt_a))).
...
Proof.
  ...
  - destruct (decide (lncf Q (large_production (terminal a) σ Xn) (leaf a) τ t2)).
    + apply repair_cr_well_formed. constructor; auto. constructor.
    + destruct n. intros ???. inv H0. inv H2.
  - destruct (decide (lncf Q (large_production E σ Xn) (small_node (small_production opt_a) opt_a) τ t2)).
