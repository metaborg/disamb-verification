...
Require Export IPPCGrammar.

Create HintDb IPPCGrammar.
Hint Resolve CPrio_infix_infix_1 CPrio_infix_infix_2 CPrio_prefix_infix CPrio_infix_prefix CLeft_prefix_infix
  ...
  PostfixMatch_lm InfixMatch_dlm PrefixMatch_dlm PostfixMatch_dlm Closed_wf Closed_cf Closed_drmcf Closed_dlmcf
    : IPPCGrammar.

Section IPPCGrammarBaseLemmas.
  ...
  - destruct q; inv H.
    + destruct q1, q2; inv H1.
      * destruct q2_1, q2_2; inv H0.
        destruct (decide (prio pr (InfixProd o) (InfixProd o0))); eauto with IPPCGrammar.
        destruct (decide (left_a pr (InfixProd o) (InfixProd o0))); eauto with IPPCGrammar.
        inv H1.
      * destruct q1_1, q1_2; inv H0.
        destruct (decide (prio pr (InfixProd o) (InfixProd o0))); eauto with IPPCGrammar.
        destruct (decide (right_a pr (InfixProd o) (InfixProd o0))); eauto with IPPCGrammar.
        inv H1.
      * destruct q1_1, q1_2; inv H0.
      * destruct q1_1, q1_2; inv H0.
      * destruct q1_1, q1_2; inv H0.
    + destruct q; inv H1.
      ...
      destruct (decide (prio pr (PrefixProd o) (InfixProd o0))); eauto with IPPCGrammar.
      destruct (decide (left_a pr (PrefixProd o) (InfixProd o0))); eauto with IPPCGrammar.
      inv H1.
    + destruct q; inv H1.
      destruct q1, q2; inv H0.
      destruct (decide (prio pr (PostfixProd o) (InfixProd o0))); eauto with IPPCGrammar.
      destruct (decide (right_a pr (PostfixProd o) (InfixProd o0))); eauto with IPPCGrammar.
      inv H1.
Qed.
...
Proof.
  ...
  - destruct q; inv H.
    + destruct q1, q2; inv H1.
      destruct q2; inv H0.
      destruct (decide (prio pr (InfixProd o) (PostfixProd o0))); eauto with IPPCGrammar.
      destruct (decide (left_a pr (InfixProd o) (PostfixProd o0))); eauto with IPPCGrammar.
      inv H1.
    + destruct q; inv H1.
      destruct q; inv H0.
      destruct (decide (prio pr (PrefixProd o) (PostfixProd o0))); eauto with IPPCGrammar.
      destruct (decide (left_a pr (PrefixProd o) (PostfixProd o0))); eauto with IPPCGrammar.
      inv H1.
Qed.
...
Proof.
  ...
  - apply IHt2_1 in H. inv H. inv H0. eauto with IPPCGrammar.
  - simpl. inv H. inv H0.
    inv H1. 
    + inv H0.
    + apply IHt2_1. eauto with IPPCGrammar.
  - inv H.
  - inv H. inv H0. inv H1. inv H0.
  - cbn [has_infix_lm_conflicts] in H.
    destruct (is_lm_conflict_pattern pr (CR_infix_postfix o o0)) eqn:E.
    + apply is_lm_conflict_pattern_true in E. eauto with IPPCGrammar.
    + apply IHt2 in H. inv H. inv H0. eauto with IPPCGrammar.
  - inv H. inv H0. cbn [has_infix_lm_conflicts].
    ...
    + rewrite IHt2. eauto with IPPCGrammar.
  - inv H.
  - inv H. inv H0. inv H1. inv H0.
Qed.
...
Proof.
  ...
  - inv H.
  - inv H. inv H0. inv H1. inv H0.
  - simpl in H. apply IHt1_2 in H. inv H. inv H0. eauto with IPPCGrammar.
  - simpl. inv H. inv H0.
    inv H1.
    + inv H0.
    + apply IHt1_2. eauto with IPPCGrammar.
  - simpl in H. destruct (decide (prio pr (PostfixProd o) (PrefixProd o0))).
    + eexists. eauto with IPPCGrammar.
    + destruct (decide (right_a pr (PostfixProd o) (PrefixProd o0))).
      * eexists. eauto with IPPCGrammar.
      * apply IHt1 in H. inv H. inv H0. eexists. eauto with IPPCGrammar.
...
Lemma insert_in_wf {g} (pr : drules g) t1 o t2 :
  wf_parse_tree g t1 -> wf_parse_tree g t2 -> g.(prods) (InfixProd o) ->
  wf_parse_tree g (insert_in pr t1 o t2).
Proof.
  intros. induction t2.
  - simpl. auto with IPPCGrammar.
  - inv H0.
    insert_in_inode_destruct pr o t2_1 o0 t2_2; auto with IPPCGrammar.
  - simpl. inv H0. auto with IPPCGrammar.
  - inv H0.
    insert_in_pnode_destruct pr o t2 o0; auto with IPPCGrammar.
  - simpl. auto with IPPCGrammar.
Qed.

Lemma insert_pre_wf {g} (pr : drules g) o t2 :
  wf_parse_tree g t2 -> g.(prods) (PrefixProd o) ->
  wf_parse_tree g (insert_pre pr o t2).
Proof.
  intros. induction H; eauto with IPPCGrammar.
  - insert_pre_inode_destruct pr o t1 o0 t2;
    auto with IPPCGrammar.
  - insert_pre_pnode_destruct pr o t o0;
    auto with IPPCGrammar.
Qed.
...
Proof.
  intro. revert o t2. induction H; intros; simpl; auto using insert_in_wf, insert_pre_wf with IPPCGrammar.
Qed.

Lemma insert_post_wf {g} (pr : drules g) t1 o :
  wf_parse_tree g t1 -> g.(prods) (PostfixProd o) ->
  wf_parse_tree g (insert_post pr t1 o).
Proof.
  intros. induction H; eauto with IPPCGrammar.
  - insert_post_inode_destruct pr t1 o0 t2 o;
    auto with IPPCGrammar.
  - insert_post_pnode_destruct pr o0 t o;
    auto with IPPCGrammar.
Qed.
...
Proof.
  intro. induction H; simpl; auto using repair_in_wf, insert_pre_wf, insert_post_wf with IPPCGrammar.
Qed.
...
Lemma insert_pre_yield_preserve {g} (pr : drules g) o t2 :
  yield (insert_pre pr o t2) = o :: yield t2.
Proof.
...
Lemma insert_in_yield_preserve {g} (pr : drules g) t1 o t2 :
  yield (insert_in pr t1 o t2) = yield t1 ++ o :: yield t2.
Proof.
  induction t2; try reflexivity.
...
Lemma repair_in_yield_preserve {g} (pr : drules g) t1 o t2 :
  yield (repair_in pr t1 o t2) = yield t1 ++ o :: yield t2.
Proof.
  ...
  - simpl. rewrite insert_in_yield_preserve. reflexivity.
  - simplify_list_eq. rewrite insert_in_yield_preserve. simplify_list_eq. reflexivity.
Qed.

Lemma insert_post_yield_preserve {g} (pr : drules g) t1 o :
  yield (insert_post pr t1 o) = yield t1 ++ [o].
Proof.
...
Proof.
  destruct t2; eauto 6 with IPPCGrammar.
  - insert_in_inode_destruct pr o t2_1 o0 t2_2; eauto 7 with IPPCGrammar.
  - insert_in_pnode_destruct pr o t2 o0; eauto 7 with IPPCGrammar.
Qed.
...
Proof.
  ...
  - inv H. inv H1.
  - inv H. inv H1. left.
    eexists. split; auto with IPPCGrammar.
    insert_in_inode_destruct pr o t2_1 o0 t2_2; auto with IPPCGrammar. exfalso. apply H with x; auto with IPPCGrammar.
  - inv H. inv H1.
  - right. eexists. split; auto with IPPCGrammar.
    insert_in_pnode_destruct pr o t2 o0; auto with IPPCGrammar. exfalso. apply H1 with x; auto.
  - inv H. inv H1.
Qed.
...
Proof.
  intros. induction t2 as [l2|t21 ? o2 t22|o2 t22|t21 ? o2|a21 t2 a22].
  ...
  - insert_in_inode_destruct pr o t21 o2 t22.
    + inv H1. apply Infix_cf; auto. intro. inv H1. inv H3. icp_cases H1; inv H4.
      * destruct H6. eexists. eauto with IPPCGrammar.
      * inv H9. decompose [or] (insert_in_top pr t1 o t21); rewrite <- H3 in *.
        **inv H4. eauto using safe_infix_infix.
        **inv H5. inv H4. inv H9. destruct H6. eexists. eauto with IPPCGrammar.
        **inv H5. inv H4. inv H9.
    + inv H1. apply Infix_cf; auto with IPPCGrammar. intro. inv H1. inv H3. icp_cases H1; inv H4.
      * destruct H6. eexists. eauto with IPPCGrammar.
      * inv E2. inv H3. inv H5. inv H3.
        ...
        **inv H5. inv H9. inv H10. destruct H6. eexists. eauto with IPPCGrammar.
        **inv H5. inv H9. inv H10.
    + apply Infix_cf; auto. intro. inv H4. inv H5. icp_cases H4; inv H6.
      * inv H13. contradiction.
      * inv H8. apply H2 with x1; auto with IPPCGrammar.
  - simpl. apply Infix_cf; auto with IPPCGrammar. intro. inv H3. inv H4. icp_cases H3; inv H5. inv H12. inv H1.
    eapply H2; eauto with IPPCGrammar.
  - insert_in_pnode_destruct pr o t21 o2.
    + inv H1. apply Postfix_cf; auto with IPPCGrammar. intro. inv H1. inv H3. icp_cases H1; inv H4. inv H7. inv E.
      inv H4. inv H8.
      * inv H4. decompose [or] (insert_in_top pr t1 o t21); rewrite <- H3 in *.
        **inv H4. eauto using safe_infix_postfix.
        **inv H8. inv H4. inv H12. destruct H5. eexists. eauto with IPPCGrammar.
        **inv H8. inv H4. inv H12.
      * apply insert_in_top_unchanged with pr t1 o t21 x2 in H13; auto. destruct H13; auto; rewrite <- H3 in *.
        **inv H4. inv H8. inv H10. destruct H5. eexists. eauto with IPPCGrammar.
        **inv H4. inv H8. inv H10.
    + apply Infix_cf; auto with IPPCGrammar. intro. inv H4. inv H5. icp_cases H4; inv H6. inv H13. inv H8.
      eapply H2; eauto with IPPCGrammar.
  - simpl. apply Infix_cf; auto. intro. inv H3. inv H4. icp_cases H3; inv H5. inv H12. inv H7.
    eapply H2; eauto with IPPCGrammar.
Qed.
...
Proof.
  destruct t2; eauto with IPPCGrammar.
  - insert_pre_inode_destruct pr o t2_1 o0 t2_2; eauto 7 with IPPCGrammar.
  - insert_pre_pnode_destruct pr o t2 o0; eauto 7 with IPPCGrammar.
Qed.
...
Proof.
  ...
  - inv H. inv H1. left.
    eexists. split; auto with IPPCGrammar.
    insert_pre_inode_destruct pr o t2_1 o0 t2_2; auto with IPPCGrammar. exfalso. apply H with x; auto with IPPCGrammar.
  - inv H. inv H1.
  - right. eexists. split; auto with IPPCGrammar.
    insert_pre_pnode_destruct pr o t2 o0; auto with IPPCGrammar. exfalso. apply H1 with x; auto.
  - inv H. inv H1.
Qed.
...
Proof.
  ...
  - insert_pre_inode_destruct pr o t21 o2 t22.
    + inv H0. apply Infix_cf; auto. intro. inv H0. inv H1. icp_cases H0; inv H2.
      * inv H12. destruct H4. eexists. eauto with IPPCGrammar.
      * decompose [or] (insert_pre_top pr o t21).
        **inv H7. rewrite <- H2 in *. inv H1.
        **inv H2. inv H1. inv H7. rewrite <- H1 in *. inv H3. destruct H4. eexists. eauto with IPPCGrammar.
    ...
    + inv H0. apply Infix_cf; auto. intro. inv H0. inv H1. inv E2. inv H1. inv H7. inv H1. icp_cases H0; inv H2.
      * destruct H4. eexists. eauto with IPPCGrammar.
      * apply insert_pre_top_unchanged with pr o t21 x0 in H11; auto. destruct H11.
        **inv H1. inv H2. inv H8. rewrite <- H2 in *. inv H7. destruct H4. eexists. eauto with IPPCGrammar.
  ...
  - insert_pre_pnode_destruct pr o t21 o2.
    + inv H0. apply Postfix_cf; auto. inv E. inv H0. intro. inv H0. inv H5. icp_cases H0; inv H6. inv H7. inv H2.
      * inv H6. decompose [or] (insert_pre_top pr o t21); rewrite <- H5 in *.
        ** inv H2.
        ** inv H6. inv H2. inv H8. destruct H3. eexists. eauto with IPPCGrammar.
        ** inv H6. inv H2. inv H8.
      * apply insert_pre_top_unchanged with pr o t21 x in H10; auto.
        destruct H10; rewrite <- H5 in *.
        ** inv H2. inv H6. inv H7. destruct H3. eexists. eauto with IPPCGrammar.
...
Proof.
  intro. revert o t2. induction t1 as [l1|t11 ? o1 t12|o1 t12|t11 ? o1|a11 t ? a12]; intros; simpl.
  - apply insert_in_icfree; auto with IPPCGrammar. intros. intro. inv H3.
  - inv H0. auto.
...
Proof.
  destruct t1; eauto with IPPCGrammar.
  - insert_post_inode_destruct pr t1_1 o0 t1_2 o; eauto 7 with IPPCGrammar.
  - insert_post_pnode_destruct pr o0 t1 o; eauto 7 with IPPCGrammar.
Qed.
...
Proof.
  ...
  - inv H. inv H1. left.
    eexists. split; auto with IPPCGrammar.
    insert_post_inode_destruct pr t1_1 o0 t1_2 o; auto with IPPCGrammar. exfalso. apply H with x; auto with IPPCGrammar.
  - right. eexists. split; auto with IPPCGrammar.
    insert_post_pnode_destruct pr o0 t1 o; auto with IPPCGrammar. exfalso. apply H1 with x; auto.
  - inv H. inv H1.
  - inv H. inv H1.
Qed.
...
Proof.
  intros. induction t1 as [l1|t11 ? o1 t12|o1 t12|t11 ? o1|a11 t1 ? a12].
  ...
  - insert_post_inode_destruct pr t11 o1 t12 o.
    + inv H0. apply Infix_cf; auto. intro. inv H0. inv H1. icp_cases H0; inv H2.
      * decompose [or] (insert_post_top pr t12 o).
        ...
        **inv H2. inv H1. inv H12. rewrite <- H1 in *. inv H3. destruct H4. eexists. eauto with IPPCGrammar.
        **inv H2. inv H1. inv H12. rewrite <- H1 in *. inv H3.
      * inv H12. destruct H4. eexists. eauto with IPPCGrammar.
    + inv H0. apply Infix_cf; auto. intro. inv H0. inv H1. inv E2. inv H1. inv H7. inv H1. icp_cases H0; inv H2.
      * apply insert_post_top_unchanged with pr t12 o x0 in H11; auto. destruct H11.
        **inv H1. inv H2. inv H7. rewrite <- H2 in *. inv H14. destruct H4. eexists. eauto with IPPCGrammar.
...
Proof.
  intro. induction t; simpl; auto using repair_in_icfree, insert_pre_icfree, insert_post_icfree with IPPCGrammar.
Qed.
...
Proof.
  ...
  - insert_in_inode_destruct pr o1 t2_1 o t2_2.
    + inv H. inv H0. auto with IPPCGrammar.
    + inv H. inv H0. auto with IPPCGrammar.
...
Proof.
  ...
  - insert_in_inode_destruct pr o t21 o2 t22.
    + inv H1. apply Infix_drmcf; auto. intro. inv H1. inv H3. rcp_cases H1; inv H4.
      destruct H6. eexists. eauto using insert_in_matches_rm with IPPCGrammar.
    + inv H1. apply Infix_drmcf; auto. intro. inv H1. inv H3. rcp_cases H1; inv H4.
      destruct H6. eexists. eauto using insert_in_matches_rm with IPPCGrammar.
    + apply Infix_drmcf; auto with IPPCGrammar. intro. inv H4. inv H5. rcp_cases H4; inv H6. eapply H2; eauto.
  - simpl. apply Infix_drmcf; auto with IPPCGrammar. intro. inv H3. inv H4. rcp_cases H3; inv H5. eapply H2; eauto.
  - insert_in_pnode_destruct pr o t21 o2.
    + inv H1. apply Postfix_drmcf; auto. intro. inv H1. inv H3. rcp_cases H1; inv H4.
      destruct H5. eexists. eauto using insert_in_matches_rm with IPPCGrammar.
    + apply Infix_drmcf; auto with IPPCGrammar. intro. inv H4. inv H5. rcp_cases H4; inv H6. eapply H2; eauto.
  - simpl. apply Infix_drmcf; auto. intro. inv H3. inv H4. rcp_cases H3; inv H5. eapply H2; eauto. 
Qed.
...
Proof.
  ...
  - insert_pre_inode_destruct pr o t2_1 o0 t2_2.
    + inv H. inv H0. left. auto with IPPCGrammar.
    + inv H. inv H0. left. auto with IPPCGrammar.
  ...
  - insert_pre_inode_destruct pr o t21 o2 t22.
    ...
    + inv H0. apply Infix_drmcf; auto. intro. inv H0. inv H1. rcp_cases H0; inv H2. inv E2. inv H1. inv H3. inv H1.
      ...
      **inv H11. inv H1. rename E into E'. insert_pre_inode_destruct pr o t21_1 o0 t21_2.
        ***inv H7. inv H1. destruct H4. eexists. eauto with IPPCGrammar.
        ***inv H7. inv H1. destruct H4. eexists. eauto with IPPCGrammar.
        ***eapply H1; eauto with IPPCGrammar.
      **inv H11. inv H1.
    ...
    + inv H0. apply Postfix_drmcf; auto. intro. inv H0. inv H1. rcp_cases H0; inv H2. inv E. inv H1. inv H6.
      * inv H1. destruct t21.
        ...
        **insert_pre_inode_destruct pr o t21_1 o0 t21_2.
          ***inv H5. inv H1. destruct H3. eexists. eauto with IPPCGrammar.
          ***inv H5. inv H1. destruct H3. eexists. eauto with IPPCGrammar.
          ***inv H5.
            ****inv H6. eauto using safe_prefix_postfix.
            ****inv H10. inv H5. destruct H3. eexists. eauto with IPPCGrammar.
        **simpl in H5. inv H5.
          ***inv H1. eauto using safe_prefix_postfix.
          ***destruct H3. eexists. eauto with IPPCGrammar.
      ...
      * destruct t21.
        ...
        **inv H9. inv H1. insert_pre_inode_destruct pr o t21_1 o0 t21_2.
          ...
          ***inv H5. inv H1. destruct H3. eexists. eauto with IPPCGrammar.
          ***inv H5.
            ****inv H6. eapply H1; eauto with IPPCGrammar.
            ****inv H9. inv H5. destruct H3. eexists. eauto with IPPCGrammar.
        **inv H9. inv H1.
        **insert_pre_pnode_destruct pr o t21 o0.
          ***inv H5. inv H1.
          ***eapply H1; eauto.
...
Proof.
  intros. induction t1 as [l1|t11 ? o1 t12|o1 t12|t11 ? o1|a11 ? a12].
...
Proof.
  intro. revert o t2. induction t1 as [l1|t11 ? o1 t12|o1 t12|t11 ? o1|a11 t1 ? a12]; intros; simpl.
  - apply insert_in_drmcfree; auto with IPPCGrammar. intros. intro. inv H3. inv H4.
  - inv H0. auto.
...
Proof.
  intro. induction t; simpl; auto using repair_in_drmcfree, insert_pre_drmcfree, insert_post_drmcfree with IPPCGrammar.
Qed.
...
Proof.
  ...
  - insert_in_inode_destruct pr o t21 o2 t22.
    + inv H1. apply Infix_dlmcf; auto. intro. inv H1. inv H2. lcp_cases H1; inv H3.
      destruct H5. eexists. eauto with IPPCGrammar.
    + inv H1. apply Infix_dlmcf; auto. intro. inv H1. inv H2. lcp_cases H1; inv H3.
      destruct H5. eexists. eauto with IPPCGrammar.
    + apply Infix_dlmcf; auto. intro. inv H3. inv H4. lcp_cases H3; inv H5. inv H12. inv H4.
      eapply H2; eauto with IPPCGrammar.
  - simpl. apply Infix_dlmcf; auto with IPPCGrammar. intro. inv H2. inv H3. lcp_cases H2; inv H4. inv H11. inv H3.
  - insert_in_pnode_destruct pr o t21 o2.
    + inv H1. apply Postfix_dlmcf; auto. intro. inv H1. inv H2. lcp_cases H1; inv H3.
    + apply Infix_dlmcf; auto with IPPCGrammar. intro. inv H3. inv H4. lcp_cases H3; inv H5. eapply H2; eauto.
  - simpl. apply Infix_dlmcf; auto. intro. inv H2. inv H3. lcp_cases H2; inv H4. inv H11. inv H3.
Qed.
...
Proof.
  ...
  - insert_pre_pnode_destruct pr o t21 o2.
    ...
    + apply Prefix_dlmcf; auto with IPPCGrammar. intro. inv H2. inv H3. lcp_cases H2; inv H4. eapply H1; eauto.
  - simpl. apply Prefix_dlmcf; auto. intro. inv H1. inv H2. lcp_cases H1; inv H3. inv H4. inv H2.
Qed.
...
Proof.
  apply Postfix_dlmcf; auto with IPPCGrammar. intro. destruct H as [q]. inv H. lcp_cases H0; inv H1.
Qed.
  ...
  - insert_post_inode_destruct pr t11 o1 t12 o.
    ...
    + inv H0. apply Infix_dlmcf; auto. intro. inv H0. inv H1. lcp_cases H0; inv H2. inv E2. inv H1. inv H3. inv H1.
      ...
      **inv H11. inv H1. rename E into E'. insert_post_inode_destruct pr t12_1 o0 t12_2 o.
        ***inv H12. inv H1. destruct H4. eexists. eauto with IPPCGrammar.
        ***inv H12. inv H1. destruct H4. eexists. eauto with IPPCGrammar.
        ***eapply H1; eauto with IPPCGrammar.
...
Proof.
  intro. revert o t2. induction t1 as [l1|t11 ? o1 t12|o1 t12|t11 ? o1|a11 t1 ? a12]; intros; simpl.
  - apply insert_in_dlmcfree; auto with IPPCGrammar.
  - inv H0. auto.
...
Proof.
  intro. induction t; simpl; auto using repair_in_dlmcfree, insert_pre_dlmcfree, insert_post_dlmcfree with IPPCGrammar.
Qed.
...
Proof.
  intros. destruct H. inv H0; inv H1; eauto with IPPCGrammar.
Qed.
...
Proof.
  ...
  decompose [or] complete_1; auto with IPPCGrammar.
  - destruct H0. auto with IPPCGrammar.
  - destruct H0. auto with IPPCGrammar.
Qed.
...
Proof.
  ...
  - insert_in_inode_destruct pr o t2_1 o0 t2_2; auto.
    + inv H1. destruct H6. eexists. eauto with IPPCGrammar.
    + inv E2. inv H2. inv H3. destruct H8. eexists. eauto with IPPCGrammar.
  - insert_in_pnode_destruct pr o t2 o0; auto. inv E. inv H2. inv H3. destruct H8. eexists. eauto with IPPCGrammar.
Qed.
...
Proof.
  ...
  - inv H0. inv H1. insert_in_inode_destruct pr o t21 o2 t22.
    + auto with IPPCGrammar.
    + inv E2. inv H0. inv H2. inv H0. auto with IPPCGrammar.
    + edestruct H0; eauto with IPPCGrammar.
  - inv H0. inv H1.
  - insert_in_pnode_destruct pr o t21 o2.
    + inv H0.
      * inv H1. auto with IPPCGrammar.
      * auto with IPPCGrammar.
    + edestruct H1; eauto with IPPCGrammar.
  - inv H0. inv H1.
Qed.
...
Proof.
  ...
  induction t2 as [l2|t21 ? o2 t22|o2 t22|t21 ? o2|a21 t ? a22].
  ...
  - insert_in_inode_destruct pr o t21 o2 t22.
    ...
    + rewrite <- IHt2_1. rename E into E'. rename E2 into E2'.
      ...
      inv H6. apply insert_in_matches_lm with pr t12 o t21 x in H12; auto. edestruct H3; eauto with IPPCGrammar.
  ...
  - insert_in_pnode_destruct pr o t21 o2.
    + rewrite <- IHt2. rename E into E'. insert_in_pnode_destruct pr o1 (insert_in pr t12 o t21) o2; auto.
      ...
      * inv H6. edestruct H3; eauto with IPPCGrammar. apply complete_trans_7 with o; auto. auto using complete_neg_3.
      * apply insert_in_matches_lm with pr t12 o t21 x in H11; auto. edestruct H3; eauto with IPPCGrammar.
        apply complete_trans_7 with o; auto. auto using complete_neg_3.
    + rename E into E'. insert_in_inode_destruct pr o1 t12 o (PostfixNode t21 o2).
      * rewrite insert_in_complete; auto.
      * destruct H1. auto using complete_neg_1.
      * destruct H1. auto using complete_neg_1.
  - assert (insert_in pr t12 o (ClosedNode a21 t a22) = InfixNode t12 o (ClosedNode a21 t a22)); auto. rewrite H3.
    insert_in_inode_destruct pr o1 t12 o (ClosedNode a21 t a22).
    + rewrite insert_in_complete; auto.
    + rewrite insert_in_complete; auto.
    + exfalso. destruct H1. auto using complete_neg_1.
Qed.
...
Proof.
  intro. inv H. inv H1. destruct t2 as [l2|t21 o2 t22|o2 t22|t21 o2|a21 t2 a22]; auto.
  - insert_pre_inode_destruct pr o t21 o2 t22; auto.
    + inv H0. destruct H4. eexists. eauto with IPPCGrammar.
    + inv E2. inv H1. inv H4. inv H1. inv H2. destruct H5. eexists. eauto with IPPCGrammar.
  - insert_pre_pnode_destruct pr o t21 o2; auto. inv E. inv H1. inv H2. destruct H6. eexists. eauto with IPPCGrammar.
Qed.
...
Proof.
  intros. assert (H0' := H0). inv H0'. inv H3. induction t2 as [l2|t21 ? o2 t22|o2 t22|t21 ? o2|a21 t2 ? a22].
  ...
  - insert_in_inode_destruct pr o t21 o2 t22.
    ...
    + rewrite IHt2_1. rename E into E', E2 into E2'.
      ...
      apply insert_in_matches_lm with pr t12 o t21 x in H12; auto. edestruct H3; eauto with IPPCGrammar.
  ...
  - insert_in_pnode_destruct pr o t21 o2.
    + rewrite IHt2. rename E into E'. insert_pre_pnode_destruct pr o1 (insert_in pr t12 o t21) o2; auto. exfalso.
      inv E'. inv H6. inv H8.
      * inv H6. edestruct H3; eauto with IPPCGrammar. apply complete_trans_8 with o; auto. auto using complete_neg_2.
      * apply insert_in_matches_lm with pr t12 o t21 x in H11; auto. edestruct H3; eauto with IPPCGrammar.
        apply complete_trans_8 with o; auto. auto using complete_neg_2.
    + rename E into E'. insert_pre_inode_destruct pr o1 t12 o (PostfixNode t21 o2).
      ...
      * rewrite insert_pre_complete; auto.
      * destruct E. auto using complete_neg_2.
  - cbn [insert_in]. insert_pre_inode_destruct pr o1 t12 o (ClosedNode a21 t2 a22).
    + rewrite insert_pre_complete; auto.
    + rewrite insert_pre_complete; auto.
    + destruct E. auto using complete_neg_2.
Qed.
...
Proof.
  ...
  revert o t2. induction t1 as [l1|t11 ? o1 t12|o1 t12|t11 ? o1|a11 t1 ? a12]; intros; simpl; auto.
  - rewrite IHt12.
    + rewrite IHt1_1.
      * rewrite insert_in_assoc; auto. apply H1. auto with IPPCGrammar.
      ...
      * intros. inv H3. rename x1 into o11, t1 into t111, t0 into t112. intro. inv H0. inv H4. destruct H10.
        eexists. eauto with IPPCGrammar.
      * intros. intro. inv H0. inv H6. inv H0. destruct H10. eexists. eauto with IPPCGrammar.
    + inv H0. inv H4. inv H3. inv H0. inv H5. auto.
    + intros. inv H3. rename x1 into o12, t1 into t121, t0 into t122. intro. apply H1 with o1; auto with IPPCGrammar.
      apply complete_trans_1 with o12; auto. apply complete_neg_1; auto. intro. inv H0. inv H5. destruct H11. eexists.
      eauto with IPPCGrammar.
    + intros. apply H2. auto with IPPCGrammar.
  - rewrite IHt12.
    + rewrite insert_in_prefix; auto. apply H2. auto with IPPCGrammar.
    + inv H0. inv H4. inv H3. inv H0. inv H5. auto.
    + intros. inv H3. rename x1 into o12, t1 into t121, t0 into t122. intro. apply H2 with o1; auto with IPPCGrammar.
...
Proof.
  ...
  - intros. intro. destruct H6. eexists. eauto with IPPCGrammar.
  - intros. intro. destruct H5. eexists. eauto with IPPCGrammar.
Qed.
...
Proof.
  intro. inv H. inv H1. destruct t1 as [l1|t11 o1 t12|o1 t12|t11 o1|a11 t1 a12]; auto.
  - insert_post_inode_destruct pr t11 o1 t12 o; auto.
    + inv H0. destruct H4. eexists. eauto with IPPCGrammar.
    + inv E2. inv H1. inv H4. inv H1. inv H. destruct H5. eexists. eauto with IPPCGrammar.
  - insert_post_pnode_destruct pr o1 t12 o; auto. inv E. inv H1. inv H. destruct H6. eexists. eauto with IPPCGrammar.
Qed.
